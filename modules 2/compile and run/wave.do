...
add wave -noupdate -color Coral -itemcolor Coral -radix hexadecimal /Caching_system_tb/DUT/Cache/write_data
...
add wave -noupdate -radix hexadecimal /Caching_system_tb/DUT/Main_Memory_U0/write_data
...
add wave -noupdate -radix decimal /Caching_system_tb/DUT/Main_Memory_U0/k
add wave -noupdate -color Magenta -itemcolor Magenta -radix hexadecimal /Caching_system_tb/WordAddress_tb
add wave -noupdate -color Magenta -itemcolor Magenta -radix hexadecimal /Caching_system_tb/DataIn_tb
add wave -noupdate -color Magenta -itemcolor Magenta -radix hexadecimal /Caching_system_tb/DataOut_tb
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1494500 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1543500 ps}
